...
rm -rf "$DEB_DIR/usr/share/termux-vapt"
mkdir -p "$DEB_DIR/usr/share/termux-vapt"
cp -a src/termux_vapt/__init__.py src/termux_vapt/auth.py \
   ...
   src/termux_vapt/templates/ "$DEB_DIR/usr/share/termux-vapt/"

echo "[2/4] Copying wrapper..."
mkdir -p "$DEB_DIR/usr/bin"
cp src/termux-vapt "$DEB_DIR/usr/bin/"
chmod 755 "$DEB_DIR/usr/bin/termux-vapt"

echo "[3/4] Copying docs..."
mkdir -p "$DEB_DIR/usr/share/doc/termux-vapt" "$DEB_DIR/usr/share/man/man1"
cp docs/README.md docs/AUTHORIZATION.md docs/INSTALL.md \
   "$DEB_DIR/usr/share/doc/termux-vapt/"
cp docs/termux-vapt.1 "$DEB_DIR/usr/share/man/man1/"
